...
<form action='<?php echo CONF_BASE_URL; ?>/builder/deploy' method='post'>
	<input type='hidden' name='tablename' value='<?php echo $tablename; ?>' />
	
	<h3 style='margin: 0px;'>Application Controller</h3>
	<i>"Please enter your controller name for your application"</i><br />	
	<p>
	<input type='text' name='controller_name' /> <i>(text and underscore only, others not allowed)</i>
	</p><br />
	
	<h3 style='margin: 0px;'>Application Functions</h3>
	<i>"Please select functions for your application"</i><br />	
	<p>
	<input type='checkbox' name='action[]' value='list' checked /> Lists<br />
	<input type='checkbox' name='action[]' value='create' checked /> Insert <br />
