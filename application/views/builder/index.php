...
<p>
	<img src="<?php echo CONF_BASE_PATH; ?>/media/img/<?php echo $permission_controller; ?>.gif"> <?php echo APPDIR; ?>controllers<br>
	<img src="<?php echo CONF_BASE_PATH; ?>/media/img/<?php echo $permission_model; ?>.gif"> <?php echo APPDIR; ?>models<br>
	<img src="<?php echo CONF_BASE_PATH; ?>/media/img/<?php echo $permission_view;?>.gif"> <?php echo APPDIR; ?>views
</p><br />
...
<?php foreach($tables as $table): ?>
	<li><a href="<?php echo CONF_BASE_PATH; ?>/builder/model/<?php echo str_replace($db_prefix, '', $table[$column_name]); ?>"><?php echo $table[$column_name]; ?></a></li>
<?php endforeach; ?>
</ul>
<!--- /table lists --->
<?php else : ?>
